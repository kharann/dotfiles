        ...
        fs.watch(extensionConfigDirectoryPath, (eventType, fileName) => {
            if (eventType === "change") {
                if (fileName === "style.less") {
                    ...
                    exports.utility.getGlobalStyles().then((css) => {
                    ...
                    exports.utility.getMermaidConfig().then((mermaidConfig) => {
                    ...
                    exports.utility.getMathJaxConfig().then((mathjaxConfig) => {
                    ...
                    exports.utility.getParserConfig().then((parserConfig) => {
                    ...
                    exports.utility.getExtensionConfig().then((config) => {
